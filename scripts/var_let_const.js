...
// +연결연산자, 더하기연산자
//홍길동은 내년에 21살이 됩니다.
console.log(user_name+'은 내년에 '+(user_age+1)+'이 됩니다.');
//홍길동은 오늘 21살이 됐습니다.
user_age = 21;
console.log('홍길동은 오늘 '+user_age+'이 됐습니다.');
...
//num변수의 데이터종류는 ?다.
console.log(`num변수의 데이터 종류는 ${typeof num}다.`)
console.log(`product_item변수의 데이터 종류는 ${typeof(product_item)}다.`)