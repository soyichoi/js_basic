...
//     e.preventDefault();
//     window.scrollTo(0, cateContent[1].offsetTop-100);
...
//     e.preventDefault();
//     window.scrollTo(0, cateContent[2].offsetTop-100);
...
//     e.preventDefault();
//     window.scrollTo(0, cateContent[3].offsetTop-100);
//     //scrollTo y좌표 수치값은 최상단(0) 또는 header의 높이 위치 정도일때 숫자로 작성한다.
//     //그 이상의 큰 값은 객체.속성을 활용해야한다.
